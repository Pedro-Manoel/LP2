...
public class Mesa implements VisaoDaMesa {
	...
	public boolean pecaEncaixa (Peca peca) {
		if (this.pecas.size() == 0){ return true; }

		return peca.encaixa(this.getNumNaDireita()) || peca.encaixa(this.getNumNaEsquerda());
	}
	 ...
	 * @return true se a peça encaixa e false caso contrário
	 */
	public boolean pecaEncaixaDireitaEsquerda (Peca peca) {
		if (this.pecas.size() == 0){ return true; }
